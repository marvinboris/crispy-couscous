...
export default function NavItem({ href, icon: Icon, children }: NavItemProps) {
    ...
    return <Link href={href}>
        <a className={classNames("flex items-center rounded-[12.5106px] w-full truncate", active ? 'text-white bg-primary-600 relative py-4 font-bold' : 'px-[11px] text-secondary-700 hover:text-primary-600')}>
