...
export default function PageTitle({ title, subtitle: defaultSubtitle, animated, animationSubtitle, icon: Icon }: PageTitleProps) {
    ...
    return <div className="relative z-0 bg-white pt-[11px] pb-[14px] pl-[30px] pr-[85px] md:px-[33px] flex md:items-center space-x-[11px] md:space-x-[14px] before:absolute before:inset-y-0 before:left-0 before:w-[9px] after:absolute after:inset-0 after:-z-10 transition-all duration-200 before:bg-green after:bg-green/[0.07]">
        <div>
            <Icon className='w-[56px] md:w-[34px] transition-all duration-200 text-green' />
        </div>
