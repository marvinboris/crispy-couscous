...
export default function SectionTitle({ title, description, icon: Icon, children }: SectionTitleProps) {
    return <div className="md:pl-8 md:pr-2.5 min-h-[69px] md:bg-white rounded-[15px] flex items-center justify-between mb-[33px] md:mb-[27px]">
        <div className='md:flex items-center'>
            ...
            <div className="text-xl md:text-lg font-bold md:font-medium">{title}</div>
